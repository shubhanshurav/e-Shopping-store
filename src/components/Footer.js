...
const Footer = () => {
  return (
    <div>
        <div className='flex flex-row border-b-2 border-gray-300 m-5'>
            {/* contact  */}
            <div className='p-5'>
            ...
            <div className='p-5'>
                ...
                <div className='flex flex-wrap flex-col pt-4 font-medium font-mono'>
                    <p>Available On Google Play Services & App Store</p>
                    <a href='/' ><img src='/assets/pay/play.jpg' alt='PlayStoreLogo' className='w-56 border-2 border-green-600 hover:border-4 rounded-2xl mb-3 mt-3' /></a>
                    <a href='/' ><img src='/assets/pay/app.jpg' alt='AppStoreLogo' className='w-56 border-2 border-green-600 hover:border-4 rounded-2xl mb-3' /></a>
                    <p>Payment Methods</p>
                    <a href='/' ><img src='/assets/pay/pay.png' alt='AppStoreLogo' className='w-64 border-2 border-green-600 hover:border-4 rounded-2xl mt-3 p-4' /></a>
                </div>
            </div>
        </div>

        <div className='flex justify-between h-10 m-6 tracking-tight'>
            <div className='text-blue-800 text-sm text-slate-600'>
                <p>©Developed by Shubhanshu Rao & Saket Singh Developers 2023</p>
            </div>
            <div className='text-blue-800 text-sm text-slate-600 '>
                <p>Privacy Policy <span>Terms of Use</span> <span>Contact Us</span></p>
            </div>
        </div>
    </div>
  )
