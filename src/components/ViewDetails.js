...
const ViewDetails = () => {
  ...
  return (
   <div className=' flex gap-x-14 m-10'>
     ...
     <div> 
            <img src={clickedData[0].image} alt="Details" loading='lazy' className='w-[500px] h-[500px] cursor-pointer object-contain hover:scale-105 transition-all' />
     </div>
    <div className='flex flex-col justify-center '>
             ...
             <p className='text-[20px] font-semibold opacity-70 py-4'>${clickedData[0].price} MRP <s >$99</s> <span className='text-orange-600 '>(55% OFF)</span>  </p> 
